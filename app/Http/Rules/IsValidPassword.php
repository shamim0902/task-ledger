...
namespace TaskLedger\App\Http\Rules;
...
// -----------------------------------------------------------------
// Rule::add('is_valid_password', \TaskLedger\App\Http\Rules\IsValidPassword::class);
// It's also possible to ommit the first key, the snake_kase class name will be used
// Rule::add(\TaskLedger\App\Http\Rules\IsValidPassword::class);
