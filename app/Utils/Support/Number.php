...
use TaskLedger\Framework\Support\InvalidArgumentException;
use TaskLedger\App\Utils\Support\NumberToWords;
use RangeException;
use TypeError;
...
class Number
{
	 ...
	 * @return float
	 */
	public static function toFloat($value, $dec = 2)
	{
	 ...
	 *
	 * @param  string $num Size value.
	 * @return int
	 * @throws \TaskLedger\Framework\Support\InvalidArgumentException
	 */
    ...
    )
    {
        ...
        switch (true) {
            case floatval($number) === 0.0:
                return $precision > 0 ? static::format(
                	0, $precision
                ) : '0';
	 ...
	 * @return string
	 */
	protected static function spellDecimal(
		$number, $numberWords, $decimalSeparator
	)
	{
	    $result = '';
