...
namespace TaskLedger\Framework\Foundation\Concerns;

use TaskLedger\Framework\Support\Facade;
...
trait DynamicFacadeTrait
{
     ...
     *
     * @param  string $facade Facade namespace prefix (e.g., TaskLedger\Framework\Facade)
