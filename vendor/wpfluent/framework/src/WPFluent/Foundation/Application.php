...
use TaskLedger\Framework\Support\Env;
use TaskLedger\Framework\Http\Client;
use TaskLedger\Framework\Foundation\Config;
use TaskLedger\Framework\Container\Container;
use TaskLedger\Framework\Foundation\ComponentBinder;
use TaskLedger\Framework\Foundation\Concerns\FoundationTrait;

/**
 * @property \TaskLedger\Framework\Foundation\Config $config
 * @property \TaskLedger\Framework\Http\Router\Router $router
 * @property \TaskLedger\Framework\Http\Request\Request $request
 * @property \TaskLedger\Framework\Http\Response\Response $response
 */
class Application extends Container
{
     ...
     * 
     * @param \TaskLedger\Framework\Http\Router $router
     * 
     * @return void
     */
