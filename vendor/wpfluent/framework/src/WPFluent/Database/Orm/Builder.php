...
use TaskLedger\Framework\Support\HelperFunctionsTrait;
use TaskLedger\Framework\Database\Query\Expression;
use TaskLedger\Framework\Database\Concerns\BuildsQueries;
use TaskLedger\Framework\Database\RecordsNotFoundException;
use TaskLedger\Framework\Database\Orm\Relations\Relation;
use TaskLedger\Framework\Database\Orm\Relations\BelongsToMany;
use TaskLedger\Framework\Database\Orm\RelationNotFoundException;
use TaskLedger\Framework\Database\Orm\Concerns\QueriesRelationships;
use TaskLedger\Framework\Database\UniqueConstraintViolationException;
use TaskLedger\Framework\Database\Query\Builder as QueryBuilder;

/**
 * @property-read HigherOrderBuilderProxy $orWhere
 *
 * @mixin \TaskLedger\Framework\Database\Query\Builder
 *
 * @template TModel of \TaskLedger\Framework\Database\Orm\Model
 */
class Builder
{
     ...
     *
     * @var \TaskLedger\Framework\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \TaskLedger\Framework\Database\Orm\Model
     */
    protected $model;
     ...
     * @return \TaskLedger\Framework\Database\Orm\Model|static
     */
     ...
     * @param  \TaskLedger\Framework\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \TaskLedger\Framework\Database\Orm\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $value
     * @param  string  $boolean
     * @return \TaskLedger\Framework\Database\Orm\Model|static|null
     */
     ...
     *
     * @param  \Closure|array|string|\TaskLedger\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\TaskLedger\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\TaskLedger\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \TaskLedger\Framework\Database\Orm\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \TaskLedger\Framework\Database\Orm\Model|\TaskLedger\Framework\Database\Orm\Collection|static[]|static|null
     */
     ...
     *
     * @param  \TaskLedger\Framework\Support\ArrayableInterface|array  $ids
     * @param  array  $columns
     * @return \TaskLedger\Framework\Database\Orm\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \TaskLedger\Framework\Database\Orm\Model|\TaskLedger\Framework\Database\Orm\Collection|static|static[]
     *
     * @throws \TaskLedger\Framework\Database\Orm\ModelNotFoundException
     */
     ...
     * @return TModel|TValue|\TaskLedger\Framework\Database\Orm\Collection
     */
     ...
     * @return \TaskLedger\Framework\Database\Orm\Model|static|mixed
     */
     ...
     * @return \TaskLedger\Framework\Database\Orm\Model
     *
     * @throws \TaskLedger\Framework\Database\Orm\ModelNotFoundException
     ...
     * @return mixed
     *
     * @throws \TaskLedger\Framework\Database\Orm\ModelNotFoundException<TModel>
     * @throws \TaskLedger\Framework\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  array|string  $columns
     * @return \TaskLedger\Framework\Database\Orm\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \TaskLedger\Framework\Database\Orm\Relations\Relation
     */
     ...
     * @return \TaskLedger\Framework\Pagination\LengthAwarePaginator
     *
     ...
     * @return \TaskLedger\Framework\Pagination\CursorPaginator
     */
     ...
     *
     * @param  array  $attributes
     * @return \TaskLedger\Framework\Database\Orm\Model|$this
     */
     ...
     *
     * @param  \TaskLedger\Framework\Database\Orm\Model  $model
     * @return $this
     */
     ...
     *
     * @param  array|\TaskLedger\Framework\Database\Query\Expression  $columns
     * @return array
     */
