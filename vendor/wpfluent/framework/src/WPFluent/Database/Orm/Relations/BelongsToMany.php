...
namespace TaskLedger\Framework\Database\Orm\Relations;
...
use TaskLedger\Framework\Database\Orm\ModelNotFoundException;
use TaskLedger\Framework\Database\Query\Grammars\MySqlGrammar;
use TaskLedger\Framework\Database\Orm\Relations\Concerns\AsPivot;
use TaskLedger\Framework\Database\UniqueConstraintViolationException;
use TaskLedger\Framework\Database\Orm\Relations\Concerns\InteractsWithDictionary;
use TaskLedger\Framework\Database\Orm\Relations\Concerns\InteractsWithPivotTable;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @var array<string|\TaskLedger\Framework\Database\Query\Expression>
     */
     ...
     *
     *
     * @param  \TaskLedger\Framework\Database\Orm\Builder<TRelatedModel>  $query
     ...
     *
     * @param  \TaskLedger\Framework\Database\Orm\Builder<TRelatedModel>|null  $query
     * @return $this
     */
     ...
     *
     * @param  \TaskLedger\Framework\Database\Orm\Collection<int, TRelatedModel>  $results
     ...
     *
     * @param  string|\TaskLedger\Framework\Database\Query\Expression|array<string, string>  $column
     * @param  mixed  $value
     * @return $this
     *
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \TaskLedger\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \TaskLedger\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel|null
     */
     ...
     * @param  array  $columns
     * @return \TaskLedger\Framework\Database\Orm\Collection<int, TRelatedModel>
     */
     ...
     * @return \TaskLedger\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel
     *
     * @throws \TaskLedger\Framework\Database\Orm\ModelNotFoundException<TRelatedModel>
     */
     ...
     * @return \TaskLedger\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel|TValue
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \TaskLedger\Framework\Pagination\Paginator
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \TaskLedger\Framework\Support\LazyCollection<int, TRelatedModel>
     */
     ...
     *
     * @return \TaskLedger\Framework\Database\Orm\Builder<TRelatedModel>
     */
     ...
     *
     * @return \TaskLedger\Framework\Support\Collection<int, int|string>
     */
     ...
     *
     * @template TContainer of \TaskLedger\Framework\Support\Collection<array-key, TRelatedModel>|array<array-key, TRelatedModel>
     *
     ...
     *
     * @param  \TaskLedger\Framework\Database\Orm\Builder<TRelatedModel>  $query
     * @param  \TaskLedger\Framework\Database\Orm\Builder<TDeclaringModel>  $parentQuery
     ...
     *
     * @param  string|\TaskLedger\Framework\Database\Query\Expression  $column
     * @return string|\TaskLedger\Framework\Database\Query\Expression
     */
