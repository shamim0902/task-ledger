...
use TaskLedger\Framework\Database\Orm\SoftDeletes;
...
abstract class HasOneOrManyThrough extends Relation
{
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \TaskLedger\Framework\Database\Orm\Model| \TaskLedger\Framework\Database\Orm\Collection<int, TRelatedModel>
     *
     ...
     * @param  (\Closure(): TValue)|null  $callback
     * @return \TaskLedger\Framework\Database\Orm\Model|\TaskLedger\Framework\Database\Orm\Collection<int, TRelatedModel>|TValue
     */
