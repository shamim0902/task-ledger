...
use TaskLedger\Framework\Support\UrlRoutable;
use TaskLedger\Framework\Support\JsonableInterface;
use TaskLedger\Framework\Support\ArrayableInterface;
use TaskLedger\Framework\Support\HelperFunctionsTrait;
use TaskLedger\Framework\Support\CanBeEscapedWhenCastToString;
use TaskLedger\Framework\Support\Collection as BaseCollection;
...
use TaskLedger\Framework\Database\Orm\Collection as OrmCollection;
use TaskLedger\Framework\Database\ConnectionResolverInterface as Resolver;
...
abstract class Model implements ArrayableInterface, ArrayAccess, CanBeEscapedWhenCastToString, JsonableInterface, JsonSerializable, UrlRoutable
{
     ...
     *
     * @var \TaskLedger\Framework\Database\ConnectionResolverInterface
     */
     ...
     *
     * @var \TaskLedger\Framework\Events\Dispatcher
     */
     ...
     * @return $this
     *
     * @throws \TaskLedger\Framework\Database\Orm\MassAssignmentException
     */
     ...
     *
     * @param  string|null  $connection
     * @return \TaskLedger\Framework\Database\Orm\Builder
     */
     ...
     *
     * @param  \TaskLedger\Framework\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     *
     * @return \TaskLedger\Framework\Database\Orm\Builder|static
     */
     ...
     *
     * @param  \TaskLedger\Framework\Database\Orm\Builder  $builder
     * @return \TaskLedger\Framework\Database\Orm\Builder
     */
     ...
     * @return \TaskLedger\Framework\Database\Orm\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \TaskLedger\Framework\Database\Orm\JsonEncodingException
     */
     ...
     *
     * @param  \TaskLedger\Framework\Database\Orm\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \TaskLedger\Framework\Database\Query\WPDBConnection
     */
     ...
     *
     * @return \TaskLedger\Framework\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param  \TaskLedger\Framework\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     * @return \TaskLedger\Framework\Database\Orm\Model|null
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \TaskLedger\Framework\Database\Orm\Model  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \TaskLedger\Framework\Database\Orm\Builder
     */
