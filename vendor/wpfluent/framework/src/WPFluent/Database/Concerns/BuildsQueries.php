...
use TaskLedger\Framework\Database\MultipleRecordsFoundException;
use TaskLedger\Framework\Pagination\Cursor;
use TaskLedger\Framework\Pagination\Paginator;
use TaskLedger\Framework\Pagination\CursorPaginator;
use TaskLedger\Framework\Pagination\LengthAwarePaginator;

/**
 * @template TValue
 *
 * @mixin \TaskLedger\Framework\Database\Orm\Builder
...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\TaskLedger\Framework\Support\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \TaskLedger\Framework\Support\Collection<int, TReturn>
     */
     ...
     *
     * @param  \TaskLedger\Framework\Database\Query\Builder|\TaskLedger\Framework\Database\Orm\Builder<*>  $builder
     ...
     * @param  \TaskLedger\Framework\Support\Collection  $items
     * @param  int  $perPage
     * @param  \TaskLedger\Framework\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \TaskLedger\Framework\Pagination\CursorPaginator
     */
