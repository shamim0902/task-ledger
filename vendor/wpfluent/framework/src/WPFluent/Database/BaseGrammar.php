...
abstract class BaseGrammar
{
     ...
     *
     * @param  \TaskLedger\Framework\Database\Query\Expression|string  $value
     * @return string
     */
     ...
     *
     * @param  \TaskLedger\Framework\Database\Query\Expression|string  $table
     * @return string
     */
     ...
     *
     * @param  \TaskLedger\Framework\Database\Query\Expression|string|int|float  $expression
