...
use TaskLedger\Framework\Database\QueryException;
use TaskLedger\Framework\Database\ConnectionInterface;
use TaskLedger\Framework\Database\MultipleColumnsSelectedException;
use TaskLedger\Framework\Database\Events\QueryExecuted;
use TaskLedger\Framework\Database\Query\Expression;
use TaskLedger\Framework\Database\Query\Processors\Processor;
use TaskLedger\Framework\Database\Query\Processors\MySqlProcessor;
use TaskLedger\Framework\Database\Query\Processors\SQLiteProcessor;
...
use TaskLedger\Framework\Database\Query\Grammars\SQLiteGrammar;
use TaskLedger\Framework\Database\Concerns\ManagesTransactions;
use TaskLedger\Framework\Database\DetectsLostConnections;

use TaskLedger\Framework\Database\Events\TransactionBeginning;
use TaskLedger\Framework\Database\Events\TransactionCommitted;
use TaskLedger\Framework\Database\Events\TransactionCommitting;
use TaskLedger\Framework\Database\Events\TransactionRolledBack;
...
class WPDBConnection implements ConnectionInterface
{
     ...
     *
     * @var \TaskLedger\Framework\Database\DatabaseTransactionsManager|null
     */
     ...
     * @return mixed
     *
     * @throws \TaskLedger\Framework\Database\MultipleColumnsSelectedException
     */
     ...
     * @param bool $useReadPdo
     * @return \Generator
     * @throws \TaskLedger\Framework\Database\QueryException
     */
     ...
     *
     * @param \TaskLedger\Framework\Database\Query\Grammars\Grammar $grammar
     * @return $this
     */
     ...
     *
     * @param \TaskLedger\Framework\Database\Query\Processors\Processor $processor
     * @return $this
     */
