...
use TaskLedger\Framework\Foundation\App;
use TaskLedger\Framework\Support\Arr;
use TaskLedger\Framework\Support\Str;
use TaskLedger\Framework\Support\Helper;
use TaskLedger\Framework\Support\MacroableTrait;
use TaskLedger\Framework\Support\Collection;
use TaskLedger\Framework\Pagination\Paginator;
use TaskLedger\Framework\Support\ForwardsCalls;
use TaskLedger\Framework\Support\LazyCollection;
use TaskLedger\Framework\Database\Query\Expression;
use TaskLedger\Framework\Database\Query\Grammars\Grammar;
use TaskLedger\Framework\Database\Query\Processors\Processor;
use TaskLedger\Framework\Database\Query\ConditionExpression;
use TaskLedger\Framework\Support\ArrayableInterface;
use TaskLedger\Framework\Database\ConnectionInterface;
use TaskLedger\Framework\Database\Concerns\BuildsQueries;
use TaskLedger\Framework\Database\Concerns\BuildsWhereDateClauses;
use TaskLedger\Framework\Database\Concerns\ExplainsQueries;
use TaskLedger\Framework\Database\Orm\Relations\Relation;
use TaskLedger\Framework\Database\Orm\Builder as OrmBuilder;
...
class Builder
{
     ...
     *
     * @var \TaskLedger\Framework\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \TaskLedger\Framework\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \TaskLedger\Framework\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @var \TaskLedger\Framework\Database\Query\IndexHint
     */
    public $indexHint;
     ...
     *
     * @param  \TaskLedger\Framework\Database\ConnectionInterface  $connection
     * @param  \TaskLedger\Framework\Database\Query\Grammars\Grammar|null  $grammar
     * @param  \TaskLedger\Framework\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\TaskLedger\Framework\Database\Query\Builder|\TaskLedger\Framework\Database\Orm\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\TaskLedger\Framework\Database\Query\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Closure|\TaskLedger\Framework\Database\Query\Builder|string  $table
     ...
     *
     * @param  \TaskLedger\Framework\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \TaskLedger\Framework\Database\Query\JoinClause
     */
     ...
     * @param  string  $type
     * @param  string  $table
     * @return \TaskLedger\Framework\Database\Query\JoinLateralClause
     */
     ...
     *
     * @param  \Closure|string|array|\TaskLedger\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  \TaskLedger\Framework\Database\Query\Expression|string  $column
     * @param  string  $value
     ...
     *
     * @param  string  $column
     * @param  \TaskLedger\Framework\Support\ArrayableInterface|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|\TaskLedger\Framework\Database\Query\Expression  $column
     * @param  array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     ...
     *
     * @return \TaskLedger\Framework\Database\Query\Builder
     */
     ...
     *
     * @param  \TaskLedger\Framework\Database\Query\Builder  $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \TaskLedger\Framework\Database\Query\Expression[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  \Closure|\TaskLedger\Framework\Database\Orm\Builder|\TaskLedger\Framework\Database\Query\Builder|\TaskLedger\Framework\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\TaskLedger\Framework\Database\Query\Builder|\TaskLedger\Framework\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \TaskLedger\Framework\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \TaskLedger\Framework\Database\RecordsNotFoundException
     * @throws \TaskLedger\Framework\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  \TaskLedger\Framework\Support\Collection  $items
     * @return \TaskLedger\Framework\Support\Collection
     */
     ...
     * @return \TaskLedger\Framework\Pagination\LengthAwarePaginatorInterface
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \TaskLedger\Framework\Pagination\PaginatorInterface
     */
     ...
     * @param  \TaskLedger\Framework\Pagination\Cursor|string|null  $cursor
     * @return \TaskLedger\Framework\Pagination\CursorPaginatorInterface
     */
     ...
     *
     * @return \TaskLedger\Framework\Support\LazyCollection
     */
     ...
     *
     * @param  mixed  $value
     * @return \TaskLedger\Framework\Database\Query\Expression
     */
     ...
     *
     * @return \TaskLedger\Framework\Database\ConnectionInterface
     */
     ...
     *
     * @return \TaskLedger\Framework\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \TaskLedger\Framework\Database\Query\Grammars\Grammar
     */
